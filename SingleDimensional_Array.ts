...
var empdata:String[]=["Meghna","Sumit", "Ankur","Soham"];//both initialization and declaration
//Approach 2
...
var values: (string | number)[] = ["Meghna", 100, "Ankur", 50];


//Approach 2

var values2:Array<String|number>=["Mango",500,"Banana",60];

console.log(values);

//how to access specific array element
var empdata2:String[]=["Meghna","Sumit", "Ankur","Soham"];
